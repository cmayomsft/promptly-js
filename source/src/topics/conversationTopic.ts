...
export abstract class ConversationTopic<BotTurnContext extends TurnContext, State extends ConversationTopicState, Value = any> 
    ...
    //  between turns.
    private _subTopics = new Map<string, (...args: any[]) => Topic<BotTurnContext, any>>();
    protected get subTopics(): Map<string, (...args: any[]) => Topic<BotTurnContext, any>> {
    ...
    private _activeTopic?: Topic<BotTurnContext, any>;
    ...
    public setActiveTopic(subTopicKey: string, ...args: any[]) {
    ...
    public get activeTopic(): Topic<BotTurnContext, any> | undefined {

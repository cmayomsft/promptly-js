...
export abstract class ConversationTopic<BotTurnContext extends BotContext, State extends ConversationTopicState, Value = any> 
    ...
    //  between turns.
    private _subTopics = new Map<string, (any?) => Topic<BotTurnContext, any>>();
    protected get subTopics(): Map<string, (any?) => Topic<BotTurnContext, any>> {
    ...
    public get activeTopic(): Topic<BotTurnContext, any> {

...
export abstract class ConversationTopic<BUS, BCS, S extends ConversationTopicState, V = any> extends Topic<BUS, BCS, S, V> {

    // subTopics - Map of functions used to create any sub-topics for the conversation topic
    //  between turns.
    private _subTopics = new Map<string, (any?) => Topic<BUS, BCS, any>>();
    protected get subTopics(): Map<string, (any?) => Topic<BUS, BCS, any>> {
    ...
    private _activeTopic: Topic<BUS, BCS, any>;
    ...
    public get activeTopic(): Topic<BUS, BCS, any> {

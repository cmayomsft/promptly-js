...
export abstract class ConversationTopic<BTC extends BotContext, S extends ConversationTopicState, V = any> extends Topic<BTC, S, V> {

    // subTopics - Map of functions used to create any sub-topics for the conversation topic
    //  between turns.
    private _subTopics = new Map<string, (any?) => Topic<BTC, any>>();
    protected get subTopics(): Map<string, (any?) => Topic<BTC, any>> {
    ...
    private _activeTopic: Topic<BTC, any>;
    ...
    public get activeTopic(): Topic<BTC, any> {
